...
function App() {
  ...
  const [ivaRate, setIvaRate] = useState(0.75);
  ...
  useEffect(() => {
    ...
    const ivaRetenido = iva100 * ivaRate;
    const islrRetenido = islrRate ? baseImponible * islrRate : 0;
          ...
          <div className="result-row">
            <div className="result-box with-checkboxes">
              <div className="result-title">
                IVA Retenido ({ivaRate * 100}% del IVA)
              </div>
            ...
            <div className="result-box with-checkboxes">
              <div className="result-title">
                ISLR Retenido (Base×{islrRate ? islrRate * 100 : '0'}%)
              </div>
              <div className="checkbox-group">
                <label className="checkbox-label">
                  <input
